...
import { ALL_FAQS, FaqItem } from './faq-content/faq';
import { LegalSectionItem } from './types'; // Import LegalSectionItem
...
export const getLegalContent = (): Record<string, { title: string; category: string; sections: LegalSectionItem[] }> => ({
  'privacy-policy': {
    ...
    sections: [
      ...
      {
        title: '1. Recopilación de Datos y Permisos de Google API',
        content: (
          <p>
      ...
      {
        title: '2. Requisitos de Uso Limitado de la API de Google (Google Limited Use Disclosure)',
        content: (
          <>
      ...
      {
        title: '3. Almacenamiento Local y Cookies',
        content: (
          <p>
      ...
      {
        title: '4. Derechos de los Usuarios (GDPR / ARCO)',
        content: (
          <p>
  ...
  'terms-of-service': {
    ...
    sections: [
      ...
      {
        title: '2. Propiedad Intelectual del Código',
        content: (
          <p>
      ...
      {
        title: '3. Responsabilidad del Estudiante',
        content: (
          <p>
      ...
      {
        title: '4. Comunidad y Enlaces',
        content: (
          <p>
            Esta plataforma enlaza a <a href="https://fullstack-dev-lovers.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-pink-600 font-bold hover:underline">fullstack-dev-lovers.vercel.app</a> para dar soporte a la comunidad de desarrolladores de software.
          </p>
        ),
      },
    ],
  ...
  'cookie-policy': {
    ...
    sections: [
      ...
      {
        title: '1. Cookies Técnicas e Imprescindibles',
        content: (
          <p>
      ...
      {
        title: '2. Almacenamiento Local (Local Storage)',
        content: (
          <>
            <p>
      ...
      {
        title: '3. Sin Cookies de Rastreo Comercial',
        content: (
          <p>
  ...
  'google-data-policy': {
    ...
    sections: [
      {
        title: 'Declaración Transparente de Permisos de Google',
        content: (
      ...
      {
        title: 'Alcance de Permisos Solicitados',
        content: (
          <ul className="list-disc pl-5 space-y-2">
            <li>
      ...
      {
        title: 'Cumplimiento Estricto de Limited Use',
        content: (
          <p>
